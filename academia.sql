...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2021 a las 13:43:37
...
(20, 'css', '666', 6, 6, '666666'),
(24, 'javascript', '200', 1000, 90, 'curso de javascript');
...
(34, 20, 55, 48, '2021-03-09', 0.02),
(36, 13, 55, 48, '2021-03-10', 7),
(37, 14, 55, 48, '2021-03-17', 0.67),
(39, 13, 64, 48, '2021-03-03', NULL),
(40, 20, 64, 48, '2020-03-03', 4.66),
...
(40, 'adm1', '$2y$10$2vVsk0Krv/vQe.lbTPvvuuR4SHSdS.BpxOaa3Be2ENoBUvYSs34oe', 'jose', 'vega', '1980-04-17', '620-458998', '33444555W', 'josves222@gmail.com', '../images/simpson.jpg', '4', 'administrador'),
(44, 'adm2', '$2y$10$X8qWuBqGNS83c2e9gXNsf.KZ9MKI8COHEUTYzyuflNbqvJUHgW8gq', 'pepe', 'lorca', '1950-03-10', '900-222248', '33444555W', 'cor-reo@hotmail.com', '../images/profesor2.jpg', '4', 'administrador'),
(45, 'adm3', '$2y$10$Eo7azKmMf5pK.0Sf/iJAwuZZgUGxfnmXMZ0oINMKSj/vzi8Ie0.Hi', 'Mario', 'Bros', '1995-03-01', '900-222248', '33444555W', 'cor-reo@hotmail.com', '../images/mario.jpg', '10', 'administrador'),
(48, 'pro1', '$2y$10$69IbxYuYDbGUa1JW9DndouMZlVllMuUt5PhWJ3Gvuivo4.2KHb3tC', 'leo', 'vega', '1980-01-06', '900-222248', '12000110K', 'josves222@gmail.com', '../images/homer.jpg', '3', 'profesor'),
(55, 'alu1', '$2y$10$1D9L4IDPUJKmvuvEAG0Es.6uT6FA6TSyPTgFnDCAdc/WI1u05Y0Yy', 'lisa', 'sipsom', '1999-03-01', '900-222248', '33444555W', 'core@coir.com', '../images/lisa.png', '2', 'alumno'),
(64, 'alu2', '$2y$10$Ico.NJ06VTy2XSbYF8/dque0BU.lfk4AM530xkocfFHGBtuC7Oa9.', 'mario p', 'bros', '1990-01-29', '620-458990', '11193123N', 'josves222@gmail.com', '../images/mario.jpg', '2', 'alumno'),
(72, 'pro2', '$2y$10$NhGeIW2JopD1HwcpWJ9C6eS61Jvyw52VD/xlUcO9CPVhU4t3iwLEO', 'leo', 'messi', '1980-10-12', '900-222241', '34333333Z', 'core@coir.com', '../images/Bart.png', '3', 'profesor'),
(74, 'pro3', '$2y$10$O7DOmCLkCMoXymgGnxKkROseKfhS9O6zuY3C91eXfKQVZArw67cfS', 'dsdsdsd', 'jkjkjk', '1990-11-11', '900-222241', '34333333Z', 'core@coir.com', '../images/simpson.jpg', '0', 'profesor'),
...
(86, 'alu3', '$2y$10$0hbzJ4mdU1Feu0XgCqLMfOMltAF8I4OUSRrjqVKP3usBS5FsZogiK', 'Gabriela l', 'Vega', '1980-03-12', '900-222241', '34333333Z', 'josves222@gmail.com', '../images/profesor4.jpg', '2', 'alumno'),
(89, 'adm4', '$2y$10$c8ymUY9Cy2WyjHzO/MigE.rG8rchw.VfdDHKuXg4rNPiV8YPF5E8W', 'lisa', 'simpson', '2000-11-11', '900-222246', '34333333Z', 'core@coir.com', '../images/profesor1.jpg', '10', 'administrador');
...
--
ALTER TABLE `cursos`
  MODIFY `idcursos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `factura`
--
ALTER TABLE `factura`
  MODIFY `idfactura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT de la tabla `matricula`
--
ALTER TABLE `matricula`
  MODIFY `idmatricula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `idpersonas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
